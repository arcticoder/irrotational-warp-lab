...
% Define abstract environment for twocolumn article if needed
% (article class has abstract, but title handling is different)
...
\author{\authorname \\ \small \textit{\authoraffiliation}}
...
We reproduce Celmaster \& Rubin's (2025) analysis of Lentz-style potentials, confirming:
\begin{itemize}
...
\url{https://github.com/arcticoder/irrotational-warp-lab}
...
The author thanks the broader warp drive research community for open code and discussion. Computations were performed on a Ryzen 5 3600 6-core 3.60 GHz workstation with 32GB RAM and a GeForce RTX 2060 SUPER (8GB VRAM).

\bibliographystyle{ieeetr}
\bibliography{irrotational_warp_metric}
